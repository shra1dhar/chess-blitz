/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e27b3ad4ec365982a7c62806a4b5e717)
// Runtime types generated with workerd@1.20251210.0 2026-01-01 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "MatchmakingQueue" | "GameRoom";
	}
	interface Env {
		ENVIRONMENT: "production" | "development";
		CORS_ORIGIN: "https://chess-blitz.zoony.io" | "http://localhost:3000";
		JWT_SECRET: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "CORS_ORIGIN" | "JWT_SECRET">> {}
}
